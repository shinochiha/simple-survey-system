...
// RESTAPIHandler provides a convenient interface for Question REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Question REST API handler.
...
// GetByID is the REST API handler for `GET /api/v3/questions/{id}`.
...
// Get is the REST API handler for `GET /api/v3/questions`.
...
// Create is the REST API handler for `POST /api/v3/questions`.
...
// UpdateByID is the REST API handler for `PUT /api/v3/questions/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/v3/questions/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/v3/questions/{id}`.
