...
// RESTAPIHandler provides a convenient interface for Response REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Response REST API handler.
...
// GetByID is the REST API handler for `GET /api/v3/responses/{id}`.
...
// Get is the REST API handler for `GET /api/v3/responses`.
...
// Create is the REST API handler for `POST /api/v3/responses`.
...
// UpdateByID is the REST API handler for `PUT /api/v3/responses/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/v3/responses/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/v3/responses/{id}`.
