...
// Base is common detail of surveys open api document component.
func (o *OpenAPIOperation) Base() {
	o.Tags = []string{"Survey"}
	o.HeaderParams = []map[string]any{{"$ref": "#/components/parameters/headerParam.Accept-Language"}}
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &Survey{}}, // will auto create schema $ref: '#/components/schemas/Survey' if not exists
		},
...
// Get is detail of `GET /api/v3/surveys` open api document component.
func (o *OpenAPIOperation) Get() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Get Survey"
	o.Description = "Use this method to get list of Survey"
	o.QueryParams = []map[string]any{{"$ref": "#/components/parameters/queryParam.Any"}}
	type SurveyList struct {
		app.ListModel
		Data []Survey `json:"results"`
	}
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &SurveyList{}}, // will auto create schema $ref: '#/components/schemas/Survey.List' if not exists
		},
		"400": app.OpenAPIError().BadRequest(),
		"401": app.OpenAPIError().Unauthorized(),
		"403": app.OpenAPIError().Forbidden(),
...
// GetByID is detail of `GET /api/v3/surveys/{id}` open api document component.
func (o *OpenAPIOperation) GetByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Get Survey By ID"
	o.Description = "Use this method to get Survey by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	return o
}

// Create is detail of `POST /api/v3/surveys` open api document component.
func (o *OpenAPIOperation) Create() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Create Survey"
	o.Description = "Use this method to create Survey"
	o.Body = map[string]any{"application/json": &ParamCreate{}}
	return o
}

// UpdateByID is detail of `PUT /api/v3/surveys/{id}` open api document component.
func (o *OpenAPIOperation) UpdateByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Update Survey By ID"
	o.Description = "Use this method to update Survey by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	o.Body = map[string]any{"application/json": &ParamUpdate{}}
	return o
}

// PartiallyUpdateByID is detail of `PATCH /api/v3/surveys/{id}` open api document component.
func (o *OpenAPIOperation) PartiallyUpdateByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Partially Update Survey By ID"
	o.Description = "Use this method to partially update Survey by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	o.Body = map[string]any{"application/json": &ParamPartiallyUpdate{}}
	return o
}

// DeleteByID is detail of `DELETE /api/v3/surveys/{id}` open api document component.
func (o *OpenAPIOperation) DeleteByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Delete Survey By ID"
	o.Description = "Use this method to delete Survey by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
