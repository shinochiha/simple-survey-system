...
// RESTAPIHandler provides a convenient interface for Survey REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Survey REST API handler.
...
// GetByID is the REST API handler for `GET /api/v3/surveys/{id}`.
...
// Get is the REST API handler for `GET /api/v3/surveys`.
...
// Create is the REST API handler for `POST /api/v3/surveys`.
...
// UpdateByID is the REST API handler for `PUT /api/v3/surveys/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/v3/surveys/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/v3/surveys/{id}`.
