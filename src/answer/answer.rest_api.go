...
// RESTAPIHandler provides a convenient interface for Answer REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the Answer REST API handler.
...
// GetByID is the REST API handler for `GET /api/v3/answers/{id}`.
...
// Get is the REST API handler for `GET /api/v3/answers`.
...
// Create is the REST API handler for `POST /api/v3/answers`.
...
// UpdateByID is the REST API handler for `PUT /api/v3/answers/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/v3/answers/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/v3/answers/{id}`.
